...
const text = "Jr_Dev.Hamz";

const Logo = () => (
  <div className="stage w-full h-full flex items-center justify-center ">
    <div className="font-caveat relative text-black dark:text-white text-3xl uppercase tracking-widest pt-1 px-2 pb-1">
      ...
      <div className="rounded-md sides absolute w-full h-full top-0 left-0 overflow-hidden">
      ...
      <div className="pr-1 text relative">
